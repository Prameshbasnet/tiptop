                                                                      ...
                                                                      children: [
                                                                        Container(
                                                                          ...
                                                                          alignment:
                                                                              Alignment.center,
                                                                          child:
                                                                              Image.asset('assets/images/drop_icon.png'),
                                                                          // decoration: BoxDecoration(
                                                                          //     shape: BoxShape.circle,
                                                                      ...
                                                                      children: [
                                                                        Expanded(
                                                                          ...
                                                                          child:
                                                                              Row(
                                                                            children: [
                                                                              Icon(Icons.route, color: textColor),
                                                                              SizedBox(
                                                                        ...
                                                                        Expanded(
                                                                            ...
                                                                            child:
                                                                              ...
                                                                              children: [
                                                                                MyText(
                                                                                  //  text: (myHistory[i]['total_time'] != null) ? ((myHistory[i]['total_distance'] is int && myHistory[i]['total_distance'] < 50) ? '${myHistory[i]['total_distance']} mins' : '${(myHistory[i]['total_distance'] is int ? myHistory[i]['total_distance'] : double.parse(myHistory[i]['total_distance']) / 60).round()} hr') : 'Invalid Time',
                                                                                  //  text: (double.parse(myHistory[i]['total_time']) < 50) ? '${myHistory[i]['total_time']} mins' : '${(double.parse(myHistory[i]['total_time']) / 60).round()} hr',
                                                                      ...
                                                                      children: [
                                                                        ...
                                                                        Expanded(
                                                                            ...
                                                                            child:
                                                                              ...
                                                                              children: [
                                                                                MyText(
                                                                                  text: (myHistory[i]['total_time'] != null) ? ((myHistory[i]['total_time'] is num && myHistory[i]['total_time'] < 50) ? '${myHistory[i]['total_time']} mins' : '${(myHistory[i]['total_time'] is num ? myHistory[i]['total_time'] : double.parse(myHistory[i]['total_time']) / 60).round()} hr') : 'Invalid Time',
                                                                                  //text: (double.parse(myHistory[i]['total_time']) < 50) ? '${myHistory[i]['total_time']} mins' : '${(double.parse(myHistory[i]['total_time']) / 60).round()} hr',
