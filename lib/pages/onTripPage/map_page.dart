...
import 'package:tiptop/pages/navDrawer/nav_page.dart';
...
class _MapsState
  ...
  StreamSink<
    ...
    >
  >
  get _mapMarkerSink => _mapMarkerSC.sink;
  Stream<
    List<
      Marker
    >
  >
  get carMarkerStream => _mapMarkerSC.stream;
  ...
  getLocs() async {
    ...
    final Uint8List deliveryIcons = await getBytesFromAsset(
    ...
    final Uint8List bikeIcons = await getBytesFromAsset(
    ...
    if (permission ==
            geolocs.LocationPermission.denied ||
        permission ==
            geolocs.LocationPermission.deniedForever ||
        serviceEnabled ==
            false) {
      gettingPerm++;
      ...
      if (locs !=
        ...
        setState(
          () {
            center = LatLng(
              double.parse(
                locs.latitude.toString(),
              ),
              double.parse(
                locs.longitude.toString(),
              ),
            );
  ...
  Widget build(
    ...
    double greaterLon =
        ...
        (lon *
            1.24);
    var lower = geo.encode(
      lowerLon,
      lowerLat,
    );
    var higher = geo.encode(
      greaterLon,
      greaterLat,
    );
                                              ...
                                              children: [
                                                ...
                                                Row(
                                                  ...
                                                  children: [
                                                    ...
                                                    MyText(
                                                      text: languages[choosenLanguage]['text_loc_permission_user'],
                                                      size:
                                                          media.width *
                                                          sixteen,
                                                      fontweight: FontWeight.bold,
                                                                ...
                                                                onCameraMove:
                                                                    (
                                                                      ...
                                                                      _debounce = Timer(
                                                                        _debounceDuration,
                                                                        () async {
                                                                          // Your code to update the address goes here
                                                                          setState(
                                                                            () {
                                                                              _loading = true;
                                                                            },
                                            ...
                                            child:
                                                ...
                                                ? Column(
                                                    children: [
                                                      ...
                                                      //           var val =
                                                      //               await geoCodingShortName(_centerLocation.latitude, _centerLocation.longitude);
                                                      //           setState(() {
                                                                                              ...
                                                                                              if (val.length >=
                                                                                                ...
                                                                                                if (storedAutoAddress
                                                                                                    .where(
                                                                                                      (
                                                                                                        element,
                                                                                                      ) => element['description'].toString().toLowerCase().contains(
                                                                                                        val.toLowerCase(),
                                                                                                      ),
                                                                                                    )
                                                                                                    .isNotEmpty) {
                                                                                                                ...
                                                                                                                if (addressList
                                                                                                                  ...
                                                                                                                  addressList.add(
                                                                                                                    AddressList(
                                                                                                                      ...
                                                                                                                      latlng: LatLng(
                                                                                                                        double.parse(
                                                                                                                          favAddress[i]['pick_lat'].toString(),
                                                                                                                        ),
                                                                                                                        double.parse(
                                                                                                                          favAddress[i]['pick_lng'].toString(),
                                                                                                                        ),
                                                                                                                      ),
                                                                                                                    ),
                                                                                                                  );
                                          ...
                                          child: Column(
                                            children: [
                                              Row(
                                                children: [
                                                  MyText(
                                                    text: languages[choosenLanguage]['text_add_address'],
                                                    size:
                                                        media.width *
                                                        sixteen,
                                                    fontweight: FontWeight.w600,
                                              ...
                                              (favName ==
                                                  ...
                                                  ? Container(
                                                      ...
                                                      child: TextField(
                                                        decoration: InputDecoration(
                                                          border: InputBorder.none,
                                                          hintText: languages[choosenLanguage]['text_enterfavname'],
...
class BannerImage
  ...
  State<
    BannerImage
  >
  createState() => _BannerImageState();
}

class _BannerImageState
    extends
        State<
          BannerImage
        > {
