    ...
    return InkWell(
      ...
      child: Container(
        ...
        child: Container(
          ...
          //     colors: <Color>[
          //       widget.color ?? Colors.black.withOpacity(0.1),
...
class PaymentSuccess
  ...
  State<
    PaymentSuccess
  >
  createState() => _PaymentSuccessState();
}

class _PaymentSuccessState
    extends
        State<
          PaymentSuccess
        > {
...
class PointsRedeemSuccess
    extends
        StatefulWidget {
  dynamic onTap;
  bool? transfer;
  num? points;
  num? convertionAmount;
  ...
  State<
    PointsRedeemSuccess
  >
  createState() => _PointsRedeemSuccessState();
}

class _PointsRedeemSuccessState
    extends
        State<
          PointsRedeemSuccess
        > {
          ...
          Expanded(
            child: Column(
              children: [
                ...
                MyText(
                  text: '${widget.points} ${languages[choosenLanguage]['text_reward_point_has_converted_to']} ${widget.convertionAmount} ${userDetails['currency_symbol']}',
                  textAlign: TextAlign.center,
                  size:
                      media.width *
                      eighteen,
